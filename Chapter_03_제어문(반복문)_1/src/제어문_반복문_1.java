 ...
 * 			=>화면 출력  (영화목록, 맛집목록)
 * 	일반for/향상된 for (배열, 컬렉션) 
 * 
 *  =>2차 for까지(웹에서 아주가끔 등장) ->코테
 * 	
 * 	2.while : 횟수가 없는 경우에 주로 사용 
 * 			=> 무한루프(파일 읽기,데이터 베이스)
 * 	
 * 
 * 	3. do ~ while :반드시 한번이상을 수행 (사용 빈도가 거의 없다)
 * 	--------------------------------------------------
 * | 규정/문법사항은 아니다 
 * --------------------------
 * 
...
//		}
		...
		FileReader fr = new FileReader("C:\\JavaDev\\javaStudy\\Chapter_03_제어문(반복문)_1\\src\\제어문_반복문_1.java");
		int i=0;
