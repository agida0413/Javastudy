 ...
 *                 class A
 *                 {
 *                    static int a; // 생성자호출이 없어도 사용이 가능 
 *                    static 
 *                    {
 *                       a=100;
 *                    }
 ...
 *                     }
 *                     -----------------
 *                     -----------------(X) => static에서는 인스턴스 사용이 불가능
 *                     static 
 *                     {
 *                        => 객체생성후에 사용 
 *                        a=1000;==>Error
 *                        b=2000; // static인 경우에만 사용이 가능 
 *                     }
 *                     -----------------
 *                 }
 *                 
 ...
 *                   {
 *                       구현부
 *                       static메소드나 static변수만 사용이 가능 
 *                       인스턴스는 사용이 불가능 
 *                       => 만약에 사용시에는 반드시 객체 생성후에 사용이 가능 
 *                   }
 *                   => 호출 => 클래스명.메소드()
 *                      Math.random() 
 *                   
 ...
 *                             int aaa() => int a=aaa()
 *                         *** 메소드를 호출하면 
 *                             메소드의 return까지 수행 => 호출된 위치로 돌아 온다 
 *                             
 *                    = 메소드명
 *                         *** 변수 명칭법가 동일 (식별자)
 *                         *** 길이의 제한은 없다 => 가급적이면 압축 
